...
exports.palavrasReservadas = {
    biblioteca: lexico_regular_1.default.BIBLIOTECA,
    cadeia: lexico_regular_1.default.CADEIA,
    caracter: lexico_regular_1.default.CARACTER,
    caso: lexico_regular_1.default.CASO,
    const: lexico_regular_1.default.CONSTANTE,
    contrario: lexico_regular_1.default.CONTRARIO,
    ...
    funcao: lexico_regular_1.default.FUNCAO,
    inclua: lexico_regular_1.default.INCLUA,
    inteiro: lexico_regular_1.default.INTEIRO,
    leia: lexico_regular_1.default.LEIA,
    limpa: lexico_regular_1.default.LIMPA,
    ...
    pare: lexico_regular_1.default.PARE,
    programa: lexico_regular_1.default.PROGRAMA,
    ...
    vazio: lexico_regular_1.default.VAZIO,
