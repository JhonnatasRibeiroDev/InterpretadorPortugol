...
export declare class PilhaEscoposExecucaoPortugolStudio implements PilhaEscoposExecucaoInterface {
    pilha: EscopoExecucao[];
    constructor();
    obterTodasDeclaracoesClasse(): void;
...
//# sourceMappingURL=pilha-escopos-execucao-portugol-studio.d.ts.map