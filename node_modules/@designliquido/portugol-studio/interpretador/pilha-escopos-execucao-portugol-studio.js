...
exports.PilhaEscoposExecucaoPortugolStudio = void 0;
...
class PilhaEscoposExecucaoPortugolStudio {
    constructor() {
        this.pilha = [];
    ...
    definirConstante(nomeConstante, valor, tipo) {
        ...
        let elementoAlvo = {
            valor: (0, inferenciador_1.converterValor)(tipoConstante, valor),
            tipo: tipoConstante,
    ...
    definirVariavel(nomeVariavel, valor, tipo) {
        ...
        let elementoAlvo = {
            valor: (0, inferenciador_1.converterValor)(tipoVariavel, valor),
            tipo: tipoVariavel,
            subtipo: tipoAbsoluto,
            imutavel: false,
        };
    ...
    atribuirVariavel(simbolo, valor) {
        for (let i = 1; i <= this.pilha.length; i++) {
            ...
            if (ambiente.valores[simbolo.lexema] !== undefined) {
                ...
                const valorResolvido = (0, inferenciador_1.converterValor)(tipo, valor);
...
exports.PilhaEscoposExecucaoPortugolStudio = PilhaEscoposExecucaoPortugolStudio;
//# sourceMappingURL=pilha-escopos-execucao-portugol-studio.js.map