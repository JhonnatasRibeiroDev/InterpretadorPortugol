...
export declare class NucleoExecucao extends NucleoComum implements NucleoExecucaoInterface {
    ...
    constructor(versao: string, funcaoDeRetorno?: Function, funcaoDeRetornoMesmaLinha?: Function, funcaoLimpaTela?: Function);
    funcaoLimpaTelaPadrao(): void;
     ...
     */
    executar(declaracoes: Declaracao[], manterAmbiente?: boolean): Promise<RetornoExecucaoInterface>;
    /**
