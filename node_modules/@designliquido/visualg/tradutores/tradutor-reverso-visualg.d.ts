import { Agrupamento, Atribuir, Binario, FimPara, Literal, Logico, Variavel } from '@designliquido/delegua/construtos';
import { Bloco, Declaracao, Escreva, Expressao, Para, Se, Var } from '@designliquido/delegua/declaracoes';
...
export declare class TradutorReversoVisuAlg {
    ...
    dicionarioDeclaracoes: {
        Bloco: any;
        CabecalhoPrograma: () => string;
        EscrevaMesmaLinha: any;
        Escolha: any;
        Escreva: any;
        Expressao: any;
        FimPara: any;
        InicioAlgoritmo: () => string;
        Leia: any;
        Para: any;
        Se: any;
        Var: any;
...
//# sourceMappingURL=tradutor-reverso-visualg.d.ts.map