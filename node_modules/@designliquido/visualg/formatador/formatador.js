...
exports.FormatadorVisuAlg = void 0;
...
class FormatadorVisuAlg {
    ...
    visitarExpressaoLimpaTela(expressao) {
     ...
     */
    logicaComumComentarioComOutraInstrucao() {
        const blocoAtual = this.pilhaEscoposFormatacao.topoDaPilha();
        if (blocoAtual.declaracaoAtual < blocoAtual.declaracoes.length) {
            if (blocoAtual.declaracoes[blocoAtual.declaracaoAtual + 1] instanceof construtos_1.Comentario) {
    ...
    visitarDeclaracaoDefinicaoFuncao(declaracao) {
        ...
        let primeiraOcorrenciaVar = declaracao.funcao.corpo.findIndex((item) => item instanceof declaracoes_1.Var);
        var ultimaOcorrenciaIndex = declaracao.funcao.corpo
            .slice()
            .reverse()
            .findIndex((item) => item instanceof declaracoes_1.Var);
    ...
    visitarExpressaoLogica(expressao) {
        ...
        switch (expressao.operador.tipo) {
            case lexico_regular_1.default.E:
                ...
                break;
            case lexico_regular_1.default.XOU:
    ...
    formatarDeclaracaoOuConstruto(declaracaoOuConstruto) {
        switch (declaracaoOuConstruto.constructor.name) {
            ...
            case 'AcessoMetodoOuPropriedade':
                ...
                break;
            case 'Aleatorio':
                this.visitarDeclaracaoAleatorio(declaracaoOuConstruto);
                break;
            case 'Agrupamento':
            ...
            case 'CabecalhoPrograma':
                this.visitarDeclaracaoCabecalhoPrograma(declaracaoOuConstruto);
                break;
            case 'Chamada':
...
exports.FormatadorVisuAlg = FormatadorVisuAlg;
//# sourceMappingURL=formatador.js.map