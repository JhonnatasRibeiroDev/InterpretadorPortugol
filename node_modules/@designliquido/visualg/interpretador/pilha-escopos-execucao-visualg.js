...
exports.PilhaEscoposExecucaoVisuAlg = void 0;
...
class PilhaEscoposExecucaoVisuAlg {
    constructor() {
        this.pilha = [];
    ...
    obterTodasDeleguaFuncao() {
        ...
        for (const [nome, corpo] of Object.entries(ambiente.valores)) {
            ...
            if (corpoValor instanceof estruturas_2.VisuAlgFuncao) {
...
exports.PilhaEscoposExecucaoVisuAlg = PilhaEscoposExecucaoVisuAlg;
//# sourceMappingURL=pilha-escopos-execucao-visualg.js.map