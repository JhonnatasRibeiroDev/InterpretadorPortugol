 ...
 */
export declare function velocidadeMedia(_: any, intervaloDeslocamento: number, intervaloTempo: number): number;
/**
 ...
 */
export declare function deltaS(_: any, s0: number, s: number): number;
/**
 ...
 */
export declare function deltaT(_: any, t0: number, t: number): number;
/**
 ...
 * @returns
 */
export declare function aceleracao(_: any, velocidadeFinal: number, velocidadeInicial: number, tempoFinal: number, tempoInicial: number): number;
/**
 ...
 */
export declare function mrufh(_: any, s0: number, v: number, t: number): Array<string>;
/**
 ...
 */
export declare function mruv(_: any, s0: number, s: number, a: number): Array<any>;
