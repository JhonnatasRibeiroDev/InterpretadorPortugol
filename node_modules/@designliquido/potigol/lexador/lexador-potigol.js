 ...
 */
class LexadorPotigol extends lexador_1.LexadorBaseLinhaUnica {
    constructor() {
        super();
    ...
    analisarTexto() {
        const valor = this.logicaComumCaracteres('"');
        this.adicionarSimbolo(lexico_regular_1.default.TEXTO, valor);
    }
    analisarNumero() {
        let real = false;
        ...
        switch (caractere) {
            ...
            case ':':
                ...
                if (this.simboloAtual() === '=') {
                    this.adicionarSimbolo(lexico_regular_1.default.REATRIBUIR, ':=');
                    this.avancar();
                }
                else {
            ...
            case '_':
                this.inicioSimbolo = this.atual;
                this.avancar();
                this.adicionarSimbolo(lexico_regular_1.default.TRACO_BAIXO);
                break;
            default:
